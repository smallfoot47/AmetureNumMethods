...
std::function<double(double)> Interpolate(Coord2DMap& map, const Interval<double>& interval);//makes mapping linearly continous
std::function<double(double)> Interpolate(Coord2DMap& map, const Interval<double>& interval, uint32_t n);//makes mapping linearly continous with n nodes
std::function<double(double)> Interpolate(Coord2DMap& map, const Interval<double>& interval, uint16_t poly_factor, uint32_t disloc_factor = 0);//makes mapping linearly continous with vertice-count controlled by poly_factor and input bias controlled by disloc_factor
